...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientConfiguration.content_file'
        db.add_column('weave_clientconfiguration', 'content_file', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientConfiguration.content_file'
        db.delete_column('weave_clientconfiguration', 'content_file')
